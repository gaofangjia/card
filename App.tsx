...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen relative overflow-x-hidden text-white font-sans selection:bg-blue-500 selection:text-white">
      ...
      {/* Header */}
      <header className="pt-8 pb-4 px-4 flex justify-center items-center gap-3 animate-fade-in-down print:hidden">
      ...
      {/* Footer */}
      <footer className="fixed bottom-0 w-full text-center py-4 text-slate-500 text-xs print:hidden bg-slate-900/80 backdrop-blur-md border-t border-slate-800">
        <p>让出行更清晰，让关爱更贴心</p>
      </footer>
